...
- [ ] 文档解析：支持PDF上传和arXiv链接抓取，提取文本、图片、表格
- [ ] 混合检索：向量检索 + 关键词BM25 + 语义重排序
- [ ] 多模态解析：图片表格OCR识别，结构化内容索引
- [ ] 引用溯源：每个答案标注来源页码和原始段落，一键跳转
- [ ] 多轮对话：支持上下文记忆，跨查询持续追问
- [ ] 自动评估：检索准确率、答案相关性、幻觉检测
- [ ] 流式输出：Token级别流式响应，提升用户体验
- [ ] 中英双语：支持中英论文混合检索和问答
- [ ] 在线部署：完整SaaS形态，可通过链接分享给面试官
- [ ] RESTful API：开放接口供第三方集成
